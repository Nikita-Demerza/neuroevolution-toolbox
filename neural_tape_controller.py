    ...
    def __init__(self,tacts=10,genom=None,input_size=6,output_size=2,layers_desc=None):
        ...
        if layers_desc == None:
            layers_desc = [#{'type':'gru','out':input_size+2,'cells':5,'activation':'lrelu'},
                ...
                {'type':'connection_out','out':600,'name':'conn8','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_in','out':300,'name':'conn1','activation':'linear'},
                {'type':'tolerance','out':300,'name':'tol1','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn9','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_in','out':300,'name':'conn2','activation':'linear'},                           
                {'type':'tolerance','out':300,'name':'tol2','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn1','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_in','out':300,'name':'conn3','activation':'linear'},                           
                {'type':'tolerance','out':300,'name':'tol3','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn2','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_in','out':300,'name':'conn4','activation':'linear'},                           
                {'type':'tolerance','out':300,'name':'tol4','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn3','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_in','out':300,'name':'conn5','activation':'linear'},                            
                {'type':'tolerance','out':300,'name':'tol6','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn4','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'}, 
                {'type':'connection_in','out':300,'name':'conn6','activation':'linear'},                           
                {'type':'tolerance','out':300,'name':'tol7','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn5','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},      
                {'type':'connection_in','out':300,'name':'conn7','activation':'linear'},                       
                {'type':'tolerance','out':300,'name':'tol8','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn6','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},    
                {'type':'connection_in','out':300,'name':'conn8','activation':'linear'},                        
                {'type':'tolerance','out':300,'name':'tol9','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'connection_out','out':600,'name':'conn7','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},  
