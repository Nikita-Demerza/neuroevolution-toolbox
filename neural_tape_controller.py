    ...
    def __init__(self,tacts=10,genom=None,input_size=6,output_size=2,layers_desc=None):
        ...
        if layers_desc == None:
            layers_desc = [#{'type':'gru','out':input_size+2,'cells':5,'activation':'lrelu'},
                ...
                {'type':'modulable','out':300,'name':'mod1','activation':'linear'},
                ...
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'modulator_inertial','out':300,'name':'mod1','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},                           
                {'type':'modulable','out':300,'name':'mod2','activation':'linear'},
                {'type':'ff','out':300,'activation':'lrelu'},
                {'type':'modulator_inertial','out':300,'name':'mod2','activation':'linear'},
                {'type':'ff','out':240,'activation':'lrelu'},
                {'type':'modulable','out':240,'name':'mod3','activation':'linear'},
                {'type':'ff','out':240,'activation':'lrelu'},
                {'type':'modulator_inertial','out':240,'name':'mod3','activation':'linear'},
                {'type':'ff','out':180,'activation':'lrelu'},
                {'type':'modulable','out':180,'name':'mod4','activation':'linear'},
                {'type':'ff','out':180,'activation':'lrelu'},
                {'type':'modulator_inertial','out':180,'name':'mod4','activation':'linear'},
                ...
                {'type':'ff','out':140,'activation':'lrelu'},
                {'type':'modulable','out':140,'name':'mod5','activation':'linear'},
                {'type':'ff','out':140,'activation':'lrelu'},
                {'type':'modulator_inertial','out':140,'name':'mod6','activation':'linear'},
                {'type':'ff','out':120,'activation':'lrelu'},
                {'type':'modulable','out':120,'name':'mod6','activation':'linear'},
                {'type':'ff','out':120,'activation':'lrelu'},
                {'type':'modulator_inertial','out':120,'name':'mod6','activation':'linear'},
                {'type':'ff','out':100,'activation':'lrelu'},
                {'type':'modulable','out':100,'name':'mod7','activation':'linear'},
                {'type':'ff','out':100,'activation':'lrelu'},
                {'type':'modulator_inertial','out':100,'name':'mod7','activation':'linear'},
